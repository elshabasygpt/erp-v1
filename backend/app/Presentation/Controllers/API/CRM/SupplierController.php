...
class SupplierController extends BaseTenantController
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = SupplierModel::query()->where('tenant_id', $this->getTenantId($request))
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $supplier = SupplierModel::query()->create([
    ...
    {
        $supplier = SupplierModel::query()->where('tenant_id', $this->getTenantId($request))->find($id);
    ...
    public function import(Request $request): JsonResponse
    {
        ...
        if ($xlsx = SimpleXLSX::parse($file)) {
            ...
            foreach ($rows as $item) {
                ...
                SupplierModel::query()->updateOrCreate(
    ...
    {
        $supplier = SupplierModel::query()->where('tenant_id', $this->getTenantId($request))->with(['purchaseInvoices', 'vouchers'])->find($id);

...
use App\Infrastructure\Eloquent\Models\PurchaseInstallmentModel;
use App\Presentation\Controllers\API\BaseTenantController;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Carbon\Carbon;

class PayablesReportController extends BaseTenantController
{
    public function getInstallmentReminders(Request $request): JsonResponse
    {
        ...
        $installments = PurchaseInstallmentModel::query()
        ...
        $reminders = $installments->map(function ($inst) use ($today) {
            ...
            return [
                ...
                'invoice_id' => $inst->purchase_invoice_id,
                'invoice_number' => $inst->invoice->invoice_number ?? 'N/A',
                'supplier_name' => $inst->invoice->supplier->name ?? 'Unknown',
        ...
        return $this->success($reminders, 'Installment reminders retrieved successfully');
    }
}

...
export function StickyActionFooter() {
  const { isRTL, loading, handleSubmit, items } = useInvoiceForm();
    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/80 dark:bg-[#111118]/80 backdrop-blur-xl border-t border-slate-200 dark:border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.2)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <Link href="/dashboard/sales/list" className="px-6 py-2.5 bg-slate-100 dark:bg-white/5 hover:bg-slate-200 dark:hover:bg-white/10 text-slate-700 dark:text-white rounded-xl font-bold transition-all flex items-center gap-2">
